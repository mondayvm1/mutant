  ...
  return (
    <section ref={ref} className="relative h-[120vh] overflow-hidden flex items-center justify-center">
      ...
      <motion.div className="relative z-10 max-w-6xl mx-auto px-6 text-center" style={{ opacity }}>
        ...
        <motion.h1
          className="font-display text-[clamp(4rem,12vw,12rem)] leading-[0.85] tracking-wider text-foreground mb-6"
        ...
        >
          Lower. Faster. Safer. The 4-wheeler reinvented from the ground up.
        </motion.p>
        ...
        >
          <a
            href="#reserve"
            className="inline-block px-10 py-4 bg-primary text-primary-foreground font-display text-2xl tracking-widest hover:box-glow-strong transition-shadow duration-300"
          >
            RESERVE YOURS
          </a>
          <a
            href="#discover"
            className="inline-block px-10 py-4 border border-foreground/20 text-foreground font-display text-2xl tracking-widest hover:border-primary/50 transition-colors duration-300"
          >
            DISCOVER
          </a>
        </motion.div>
